...
namespace kuzzleio {
  ...
  bool Server::adminExists(const QueryOptions& options) {
    KUZZLE_API(bool_result, r, kuzzle_admin_exists(_server, const_cast<query_options*>(options.qo())))
  ...
  std::string Server::getAllStats(const QueryOptions& options) {
    KUZZLE_API(string_result, r, kuzzle_get_all_stats(_server, const_cast<query_options*>(options.qo())))
  ...
  std::string Server::getStats(time_t start, time_t end, const QueryOptions& options) {
    KUZZLE_API(string_result, r, kuzzle_get_stats(_server, start, end, const_cast<query_options*>(options.qo())))
  ...
  std::string Server::getLastStats(const QueryOptions& options) {
    KUZZLE_API(string_result, r, kuzzle_get_last_stats(_server, const_cast<query_options*>(options.qo())))
  ...
  std::string Server::getConfig(const QueryOptions& options) {
    KUZZLE_API(string_result, r, kuzzle_get_config(_server, const_cast<query_options*>(options.qo())))
  ...
  std::string Server::info(const QueryOptions& options) {
    KUZZLE_API(string_result, r, kuzzle_info(_server, const_cast<query_options*>(options.qo())))
  ...
  long long Server::now(const QueryOptions& options) {
    KUZZLE_API(date_result, r, kuzzle_now(_server, const_cast<query_options*>(options.qo())))
